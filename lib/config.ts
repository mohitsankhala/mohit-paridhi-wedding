export const config = {
    coupleNames: process.env.NEXT_PUBLIC_COUPLE_NAMES || "Mohit & Paridhi",
    eventDate: process.env.NEXT_PUBLIC_EVENT_DATE || "2026-07-03T00:00:00",
    groom: process.env.NEXT_PUBLIC_GROOM_NAME || "Mohit",
    groomNickName: process.env.NEXT_PUBLIC_GROOM_NICKNAME || "Mohit",
    groomInstagram: process.env.NEXT_PUBLIC_GROOM_INSTAGRAM || "@Mohitsankhala",
    groomBio: process.env.NEXT_PUBLIC_GROOM_BIO || "Mohit is a passionate individual with a love for adventure and exploration.",
    bride: process.env.NEXT_PUBLIC_BRIDE_NAME || "Paridhi",
    brideNickName: process.env.NEXT_PUBLIC_BRIDE_NICKNAME || "Paridhi",
    brideInstagram: process.env.NEXT_PUBLIC_BRIDE_INSTAGRAM || "paridhi_instagram",
    brideBio: process.env.NEXT_PUBLIC_BRIDE_BIO || "Paridhi is a kind-hearted individual with a passion for art and music.",
